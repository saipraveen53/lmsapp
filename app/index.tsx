            ...
            { text: "Cancel", style: "cancel" },
            {
              ...
              onPress: async () => {
                ...
                if (!forceResult.success) {
                  Alert.alert(
                    "Login Failed",
                    forceResult.message || "Failed to force login.",
                  );
                }
              },
            },
    ...
    <View style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      ...
      >
        ...
        >
          ...
          <Text style={{ color: "#64748b", marginBottom: 25, fontSize: 13 }}>
          ...
          <View
            style={{ marginTop: "auto", paddingTop: 30, paddingBottom: 10 }}
          >
            <Text
              style={{ textAlign: "center", color: "#94a3b8", fontSize: 10 }}
            >
              © 2025 Anasol Consultancy Services Pvt Ltd.
            </Text>
          </View>
        </ScrollView>
      </View>
    ...
    <View className="flex-1 bg-gray-100 justify-center items-center p-4">
      <View className="bg-white rounded-2xl shadow-xl w-full max-w-5xl flex-row overflow-hidden min-h-[550px]">
        ...
        >
          ...
          <Text className="text-4xl font-extrabold text-white tracking-wide uppercase text-center drop-shadow-md">
            Anasol LMS
          </Text>
          <Text className="text-indigo-100 text-sm font-medium tracking-wide text-center mt-2 max-w-xs leading-relaxed">
            Empowering students with top-notch technical training.
          </Text>
          <Text className="absolute bottom-6 text-indigo-200 text-[10px] font-medium tracking-wider opacity-80">
            © 2025 Anasol Consultancy Services Pvt Ltd.
          </Text>
        </LinearGradient>
        ...
        <View className="w-1/2 p-12 bg-white justify-center">
          ...
          <View className="space-y-6">
            <View>
              ...
              <View
                className={`flex-row items-center border rounded-lg px-3 py-3 transition-all ${focusedInput === "email" ? "border-indigo-600 ring-2 ring-indigo-100" : "border-gray-300 bg-gray-50"}`}
              >
                <Ionicons
                  name="mail-outline"
                  size={20}
            ...
            <View>
              ...
              <View
                className={`flex-row items-center border rounded-lg px-3 py-3 transition-all ${focusedInput === "password" ? "border-indigo-600 ring-2 ring-indigo-100" : "border-gray-300 bg-gray-50"}`}
              >
                <Ionicons
                  name="lock-closed-outline"
                  size={20}
            ...
            <TouchableOpacity onPress={handleLogin} disabled={isLoading}>
              <LinearGradient
                ...
                className="rounded-lg shadow-lg py-4 items-center"
              >
            ...
            {errorMessage ? (
              <Text className="text-red-500 text-sm text-center mt-2 font-medium">
                {errorMessage}
              </Text>
            ) : null}
          </View>
